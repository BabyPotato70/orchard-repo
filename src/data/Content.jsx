...
export const navLinks = [
  ...
  { label: "Our Orchard", path: "/orchard" },
...
export const timeline = [
  {
    year: "1990",
    event:
      "First apple saplings planted in Chhajpur village. Started with Red Delicious and Golden Delicious varieties.",
  },
  {
    year: "1998",
    event:
      "First successful harvest sold to Shimla markets. Built relationships with local wholesalers.",
  },
  {
    year: "2005",
    event:
      "Expanded orchard to include Fuji, Gala, and Granny Smith. Introduced modern pruning techniques.",
  },
  {
    year: "2012",
    event:
      "Set up dedicated packing facility with grading and sorting infrastructure.",
  },
  {
    year: "2018",
    event:
      "Began direct-to-consumer sales. Shipped first interstate orders to Delhi and Mumbai.",
  },
  {
    year: "2023",
    event:
      "Introduced Heritage Ambri variety. Adopted eco-friendly packaging and reduced chemical usage by 60%.",
  },
  {
    year: "2025",
    event:
      "Launched online presence. Now serving customers across 15+ Indian states with premium Himalayan apples.",
  },
];
